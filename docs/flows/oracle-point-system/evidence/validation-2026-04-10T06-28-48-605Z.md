...
- UpdatedAt: 2026-04-10T06:28:48.605Z
- Detail: spec-validator: All 6 acceptance criteria passed per the latest validation evidence (18/18 tests). Implementation covers migration, points logic, WS push, auth integration, and match-end settlement. Advancing to validating.
...
Status: passed
Evidence: deductPoint uses WHERE constellation_points >= 10; routes.js early guard also returns insufficient_points; test user with 5pt correctly got the error
